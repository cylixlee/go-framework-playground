...
func (x *GreetRequest) GetPing() string {
	if x != nil {
		return x.Ping
	}
	return ""
...
func (x *GreetResponse) GetPong() string {
	if x != nil {
		return x.Pong
	}
	return ""
...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\x05Greet\x121\n" +
	"\x04Ping\x12\x13.proto.GreetRequest\x1a\x14.proto.GreetResponseB=Z;github.com/cylixlee/go-framework-playground/internal/proto/b\x06proto3"
...
var file_proto_greet_proto_depIdxs = []int32{
	0, // 0: proto.Greet.Ping:input_type -> proto.GreetRequest
	1, // 1: proto.Greet.Ping:output_type -> proto.GreetResponse
