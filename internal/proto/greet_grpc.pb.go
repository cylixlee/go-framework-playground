...
const (
	Greet_Ping_FullMethodName = "/proto.Greet/Ping"
)
...
type GreetClient interface {
	Ping(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error)
}
...
func (c *greetClient) Ping(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
...
func (UnimplementedGreetServer) Ping(context.Context, *GreetRequest) (*GreetResponse, error) {
...
func _Greet_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServer).Ping(ctx, req.(*GreetRequest))
	}
