...
func (x *HelloResponse) GetPong() string {
	if x != nil {
		return x.Pong
	}
	return ""
...
const file_proto_hello_proto_rawDesc = "" +
	...
	"\x05Hello\x121\n" +
	"\x04Ping\x12\x13.proto.HelloRequest\x1a\x14.proto.HelloResponseB<Z:github.com/cylixlee/go-framework-playground/internal/protob\x06proto3"
...
var file_proto_hello_proto_depIdxs = []int32{
	0, // 0: proto.Hello.Ping:input_type -> proto.HelloRequest
	1, // 1: proto.Hello.Ping:output_type -> proto.HelloResponse
